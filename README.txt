...
To recreate the pdf with the descriptive measures for the experiment 4, after the first two steps above run:

Rscript src/descriptive.R
pdflatex -output-directory doc results/descriptive.tex
...
│  ├── descriptive.pdf: summary of the raw measures from the experiment 4
