...
```{r bftable_ma_1, eval = bf_table_eval }
...
```{r bftable_ma_3, eval = bf_table_eval }
...
```{r bftable_ma_, eval = bf_table_eval }
...
```{r bftable_ma_4, eval = bf_table_eval }
...
```{r bftable_ma_5, eval = bf_table_eval }
